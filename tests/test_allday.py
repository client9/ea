...
class TestSingleDayAllDay:
    def test_ooo_creates_opaque_event(self):
        ...
        action = handle_allday_block(
            parsed, gmail.get_thread("t-allday"), gmail, calendar, CONFIG
        )
    ...
    def test_vacation_opaque(self):
        ...
        calendar = _make_calendar()
        handle_allday_block(
            _parsed(["2026-03-23"], event_type="vacation"),
            gmail.get_thread("t-allday"),
            gmail,
            calendar,
            CONFIG,
...
class TestTransparentAllDay:
    ...
    def test_transparent_confirmation_says_free(self):
        ...
        calendar = _make_calendar()
        handle_allday_block(
            _parsed(["2026-04-15"], event_type="conference", topic="PyCon"),
            gmail.get_thread("t-allday"),
            gmail,
            calendar,
            CONFIG,
    ...
    def test_ooo_block_types_are_opaque(self):
        for event_type in ("ooo", "vacation", "block"):
            ...
            calendar = _make_calendar()
            handle_allday_block(
                _parsed(["2026-03-23"], event_type=event_type),
                gmail.get_thread("t-allday"),
                gmail,
                calendar,
                CONFIG,
            ...
            ev = calendar.events_created[0]
            assert ev["transparency"] == "opaque", (
                f"Expected opaque for event_type={event_type!r}"
            )
...
class TestTopicDefaults:
    ...
    def test_default_topics(self, event_type, expected_topic):
        ...
        calendar = _make_calendar()
        handle_allday_block(
            _parsed(["2026-03-23"], event_type=event_type, topic=None),
            gmail.get_thread("t-allday"),
            gmail,
            calendar,
            CONFIG,
    ...
    def test_explicit_topic_overrides_default(self):
        ...
        calendar = _make_calendar()
        handle_allday_block(
            _parsed(["2026-03-23"], event_type="ooo", topic="At offsite"),
            gmail.get_thread("t-allday"),
            gmail,
            calendar,
            CONFIG,
...
class TestPollDispatch:
    ...
    def test_non_allday_block_still_uses_evaluate_parsed(self):
        ...
        gmail.seed_thread(
            ...
            [
                FakeMsg(
                    ...
                    MY_EMAIL,
                    "Block lunch",
                    "EA: block Thursday 12-1pm for lunch",
                ),
            ],
        )
        calendar = _make_calendar()
        ...
        parsed_result = {
            ...
            "topic": "Lunch",
            "proposed_times": [
                {"text": "Thursday 12-1pm", "datetimes": ["2026-03-19T16:00:00+00:00"]}
            ],
            "new_proposed_times": [],
            "attendees": [],
            "duration_minutes": 60,
